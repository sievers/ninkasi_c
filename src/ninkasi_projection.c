...
int set_map_projection_cea_simple( MAP *map)
{
  ...
  map->projection->radelt= -map->projection->decdelt;
  mprintf(stdout,"Map limits in set_map_projection_cea_simple are %14.8f %14.8f %14.8f %14.8f with pixsize %14.8f %14.8f\n",map->ramin,map->ramax,map->decmin,map->decmax,map->projection->decdelt,map->projection->radelt);
